...
class _PartyCartState extends State<PartyCart> {
  ...
  Widget build(BuildContext context) {
    ...
    final cartItem = cartItemData.partyMealCart(routeArgs['id'] as String?);
      ...
      bottomNavigationBar: Container(
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            ...
            //             cartItemData.totalPrice(routeArgs['id']),
            //             diliveryCharges(),
            //             percentage)
            //         .round(),
            //     'OrderHistoryInfo': OrderHistoryDefenation(
            //       counters: getCounters(cartItem),
            //       orderedMeals: cartItem,
            //       totalPrice: finalPrice(
            //               cartItemData.totalPrice(routeArgs['id']),
            //               diliveryCharges(),
            //               percentage)
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            '- Rs. ${((cartItemData.totalPrice(routeArgs['id'] as String?) + diliveryCharges()) * (percentage / 100)).toStringAsFixed(1)}',
                            style: TextStyle(
                              fontSize: 15,
                              color: Colors.white,
                              fontWeight: FontWeight.w700,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Rs ${finalPrice(cartItemData.totalPrice(routeArgs['id'] as String?), diliveryCharges(), percentage).round()}',
                            style: TextStyle(
                              fontSize: 15,
                              color: Colors.white,
                              fontWeight: FontWeight.w700,
