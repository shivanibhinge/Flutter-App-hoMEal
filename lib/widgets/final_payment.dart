...
import 'package:flutter_smart_home_ui/models/meal_defenation.dart';
import 'package:flutter_smart_home_ui/models/orderHistory_defenation.dart';
      ...
      bottomNavigationBar: showBottomBar
          ? Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  mealData.resetCounters(cartMealsData as List<Meal>);
                  orderHistoryProvider.addOrderHistory(orderedItemsData as OrderHistoryDefenation?);
                  mealData.removeAllCartItems(cartMealsData);
                  Navigator.of(context)
                      .popAndPushNamed(PaymentGateway.routeName);
                },
              ),
            )
          : Container(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  setState(() {
                    selectedRadiaValue1 != 4
                        ? selectedRadiaValue1 = 4
                        : selectedRadiaValue1 = 0;
                  });
                },
                child: Card(
                  elevation: 10,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Radio(
                            value: 4,
                            groupValue: selectedRadiaValue1,
                            onChanged: (dynamic value) {},
                          ),
                          Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: NetworkImage(
                                      'https://static.thenounproject.com/png/123880-200.png')),
                            ),
                            height: MediaQuery.of(context).size.height * 0.08,
                            width: MediaQuery.of(context).size.width * 0.08,
                            margin: EdgeInsets.only(right: 8),
